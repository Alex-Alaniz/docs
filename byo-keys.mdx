...
However, a **running gateway is required** to actually use them. Currently, gateway provisioning requires an active OpenClaws Pro subscription ($29/mo). When you subscribe, your gateway automatically picks up any previously saved keys.
...
| **Deploy gateway** (use everything above) | **Yes ($29/mo)** |
