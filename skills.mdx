...
<CardGroup cols={3}>
  <Card title="GitHub" icon="github">Manage repos, issues, and PRs</Card>
  <Card title="Notion" icon="n">Create and search pages</Card>
  <Card title="Slack" icon="slack">Send messages, read channels</Card>
  <Card title="Discord" icon="discord">Bot interactions and DMs</Card>
  ...
  <Card title="Spotify" icon="spotify">Music playback control</Card>
